...
import { AddCvSkillForm, UpdateCvSkillForm, useCv, useDeleteCvSkills } from '~/features/cvs';
import { useAuth, useEditingState } from '~/shared/hooks';
import { type SkillMastery } from '~/shared/types';
import { Button, Count, Modal, PageTitle, SkillBar } from '~/shared/ui';
import { deleteSkillsSchema } from '../models';

const routeApi = getRouteApi('/_mainLayout/cvs/$cvId/_cvsLayout/skills');

export function CvsSkillsPage() {
